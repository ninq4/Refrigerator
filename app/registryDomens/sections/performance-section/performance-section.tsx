          ...
          <ul className={style.performance_section__list}>
            ...
            <li className={style.performance_section__item}>
              <div className={style.performance_section__imageBorder}>
                <Image className={style.performance_section__item_image} alt="" src={''} />
              </div>
              <h5 className={style.performance_section__item_title}>Низкие цены</h5>
            ...
            <li className={style.performance_section__item}>
              ...
              <h5 className={style.performance_section__item_title}>Поддержка 24/7</h5>
              <p className={style.performance_section__item_descr}>
