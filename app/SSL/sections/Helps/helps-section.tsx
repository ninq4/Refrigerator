import style from './helps.module.scss';
import Link from 'next/link';
import Image from 'next/image';
export const HelpsSection = () => {
  return (
    <section className={`{"main__helps_section"} ${style.section}`}>
        ...
        <div className={style.section__inner}>
          ...
          <ul className={style.section__list}>
            <li className={style.section__list_item}>
              <article className={`${style.section__list_article} ${style.article}}`}>
                <div className={style.article__block}>
                  ...
                  <div className={style.article__img}>
                    <Image src="/icon1.png" width={100} height={100} alt="icon" />
                  </div>
                </div>
            ...
            <li className={style.section__list_item}>
              <article className={`${style.section__list_article} ${style.helps_article}}`}>
                <div className={style.article__block}>
                  <h4 className={style.article__title}>Блог</h4>
                  <div className={style.article__img}>
                    <Image src="/icon3.png" width={100} height={100} alt="icon" />
                  </div>
                </div>
                <p className={style.article__descr}>
