        ...
        <ul className={style.guarantee_section__inner}>
          <li className={style.guarantee_section__card}>
            ...
            <p className={style.guarantee_section__card_descr}>
              Вы сможете получать отчетные документы на электронную почту или через электронный
              документооборот (ЭДО).
            </p>
          </li>
          <li
            ...
            <p
              ...
              Чтобы упростить оплату наших услуг и сделать финансовые операции более удобными, мы
              предоставляем вам безналичные платежи.
            </p>
          </li>
          <li className={style.guarantee_section__card}>
            <div className={style.guarantee_section__imageBorder}>
            ...
            <h5 className={style.guarantee_section__card_title}>Единый реестр программ РФ</h5>
            <p className={style.guarantee_section__card_descr}>
              Запись в реестре № 1234 от 19.11.2022 произведена на основании приказа Министерства
              цифрового развития, связи и массовых коммуникаций РФ от 19.11.2019 № 742
            </p>
          </li>
        </ul>
      </div>
